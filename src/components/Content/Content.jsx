...
export default () => (
  <div className="content">
    ...
    <Section children={<Skills />} className={"section-skills"} title={"Skills"} bgColor={"bg-secondary"} />
    <Section children={<Education />} className={"section-education"} title={"Education"} bgColor={"bg-primary"} />
